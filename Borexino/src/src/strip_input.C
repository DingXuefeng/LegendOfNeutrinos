...
void strip_input(std::string input_fc,std::string output_fc,std::vector<std::string> hists,bool keepQ = true, bool keepNpmt = false, bool keepNhit = false, bool keepMV = false) {
  ...
  auto Npe = {
    "pp/geometrical_correction/final_charge_pp_geo_0"
      ,"pp/geometrical_correction/final_charge_pp_geo_1"
      ,"pp/geometrical_correction/final_charge_pp_geo"
      ,"pp/geometrical_correction/h_n_used_charge_weighted_geo"
